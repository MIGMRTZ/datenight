...
**Project:** DateNight
**Primary Goal:** The system discovers movies, restaurants, and activities near you, generates deep links for booking, and produces .ics calendar files — all from the terminal.
